...
<head>
    ...
    <!-- Favicon Icon -->
{{--    <link rel="shortcut icon" href="https://dashhub.pixcelsthemes.com/DashHub/assets/images/favicon.ico">--}}
...
<div class="bg-white dark:bg-dark text-dark dark:text-white">
    ...
    <div class="main-container flex mx-auto">
        ...
        <div class="main-content flex-1">
            <!-- Start Topbar -->
            <div class="h-[60px] bg-white  justify-between border-b-2 border-lightgray/10 flex items-center gap-2.5 px-7">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="profile z-10" x-data="dropdown" @click.outside="open = false">
                        <button type="button" class="flex items-center gap-2.5" @click="toggle()">
                            <img class="h-[38px] w-[38px] rounded-full" src="{{Storage::url('admin/images/avatars/user.png')}}" alt="Header Avatar">
            ...
            <!-- Start Content -->
            <div class="h-[calc(100vh-60px)] relative overflow-y-auto overflow-x-hidden px-5 pt-5 space-y-5">
                <!-- Start All Card -->
                <div class="flex flex-col gap-5 min-h-[calc(100vh-151px)]">
                    ...
                    <div class="grid grid-cols-1 gap-5" id="admin-content">
                        @yield('content')
                    </div>
                </div>
                <!-- End All Card -->
                ...
                <!-- Start Footer -->
                <footer class="footer -mx-8 font-normal font-inter text-xs bg-white leading-normal shadow-[0_0_0.4rem_rgba(0,0,0,0.1)] py-4 text-center">
                    <div class="container">
                    <span class="text-gray"> Copyright ©
                        <span id="year"></span>
                        <a href="javascript:void(0);" class="text-defaulttextcolor font-semibold">Ynex</a>.
...
@include('admin.layouts.shared._modal')
@include('admin.layouts.shared._toastr')
@include('admin.layouts.shared._hidden')
