    ...
    <div class="relative p-4 w-full max-w-7xl max-h-full top-24 mx-auto">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 id="modal-header" class="text-xl font-semibold text-gray-900">

                </h3>
                <button id="ok-btn" type="button" class="text-orange-500 bg-transparent hover:bg-gray-200 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="static-modal">
