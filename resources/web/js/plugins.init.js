...
try {
    const Default = {
        defaultTabId: null,
        activeClasses: 'text-orange-500 border-b-0',
        inactiveClasses: 'hover:text-orange-500 border-b',
        onShow: () => { }
    }
...
try {
    const Default = {
        alwaysOpen: false,
        activeClasses: 'bg-gray-50 text-orange-500',
